        ...
        <section class="col-lg-12 connectedSortable">
          <div class="box box-primary"> 
            ...
            <div class="box-header">
              ...
              <button class="btn btn-success pull-right"> Crear Tarea </button>
            </div>
...
<!-- Modal -->
<div class="modal fade" id="infoUsuario" role="dialog">
    <div class="modal-dialog">
      <!-- Modal content-->
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h4 class="modal-title"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;User information&nbsp;&nbsp;<i id="success_save" class='fa fa-check-circle-o' style='color:green; display:none;' aria-hidden='true'></i></h4>
        </div>
